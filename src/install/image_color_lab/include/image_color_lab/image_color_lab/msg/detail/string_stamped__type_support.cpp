...
{
  new (message_memory) image_color_lab::msg::StringStamped(_init);
}

void StringStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<image_color_lab::msg::StringStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StringStamped_message_member_array[2] = {
  {
    ...
    offsetof(image_color_lab::msg::StringStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(image_color_lab::msg::StringStamped, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StringStamped_message_members = {
  "image_color_lab::msg",  // message namespace
  "StringStamped",  // message name
  2,  // number of fields
  sizeof(image_color_lab::msg::StringStamped),
...
get_message_type_support_handle<image_color_lab::msg::StringStamped>()
{
  return &::image_color_lab::msg::rosidl_typesupport_introspection_cpp::StringStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, image_color_lab, msg, StringStamped)() {
  return &::image_color_lab::msg::rosidl_typesupport_introspection_cpp::StringStamped_message_type_support_handle;
}
