...
static const _StringStamped_type_support_symbol_names_t _StringStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, image_color_lab, msg, StringStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, image_color_lab, msg, StringStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, image_color_lab, msg, StringStamped)() {
  return &::image_color_lab::msg::rosidl_typesupport_c::StringStamped_message_type_support_handle;
}
