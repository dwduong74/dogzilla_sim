...
#include "image_color_lab/msg/detail/string_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = image_color_lab::msg::StringStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const image_color_lab::msg::StringStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<image_color_lab::msg::StringStamped *>(
    untyped_ros_message);
...
{
  return &image_color_lab::msg::typesupport_fastrtps_cpp::_StringStamped__handle;
}
