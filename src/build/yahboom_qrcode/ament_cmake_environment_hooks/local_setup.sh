...
: ${AMENT_CURRENT_PREFIX:="/root/yahboomcar_ws/src/install/yahboom_qrcode"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/yahboom_qrcode/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/yahboom_qrcode/environment/path.sh"
